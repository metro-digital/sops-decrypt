...
// src/command.ts
async function commandExec(command, args, stdin) {
...
// src/gpg.ts
async function gpgFingerprint(base64GPGKey) {
...
async function gpgDeleteSecretKey(fingerprint) {
...
async function gpgDeletePublicKey(fingerprint) {
...
async function gpgDeleteKey(fingerprint) {
  await gpgDeleteSecretKey(fingerprint);
  await gpgDeletePublicKey(fingerprint);
}
async function gpgKeyExists(fingerprint) {
